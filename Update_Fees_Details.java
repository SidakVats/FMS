...
public class Update_Fees_Details extends javax.swing.JFrame 
{
    ...
    {   
        try 
        {
            ...
            PreparedStatement pst = conn.prepareStatement("select Course_Name from edit_courses");
    ...
    public void Update_fees_details()
    {           
        ...
        String Student_Name       = TF5.getText();
        ...
        {
            Connection conn= DriverManager.getConnection(path ,username, password);
            PreparedStatement st = conn.prepareStatement(" Update add_fees_data set "
            + "Payment_Mode=?, DD_Cheque_Number=?,  Bank_Name=?, Date=?, GSTIN=?, Recieved_From=?,"
            + " Student_Name=?, Course_Name=?,Year_Semester=?, Roll_Number=?, Mobile_Number=?, Father_Name=?,"
            + "Annual_Charge=?, Tuition_Fees=?, Hostel_Fees=?, Amount=?, Amount_In_Words=? where Receipt_No=?");
            
            st.setString(1,  Payment_Mode);
            st.setString(2,  DD_Cheque_Number);
            st.setString(3,  Bank_Name);
            st.setString(4,  Date);
            st.setString(5,  GSTIN);
            st.setString(6,  Recieved_From);
            st.setString(7,  Student_Name);
            st.setString(8,  Course_Name);
            st.setString(9,  Year_Semester);
            st.setString(10, Roll_No);
            st.setString(11, Mobile_Number);
            st.setString(12, Father_Name);
            st.setFloat (13, Annual_Charge);
            st.setFloat (14, Tuition_Fees);
            st.setFloat (15, Hostel_Fees);
            st.setFloat (16, Amount);
            st.setString(17, Amount_In_Words);
            st.setInt   (18, Receipt_No );
    ...
    private void initComponents() {
        ...
        lbl_recipt_no.setText("Reciept No :");
        ...
        lbl_sr_no.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        lbl_particulars.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        Button_print.setFont(new java.awt.Font("Bodoni MT", 0, 48)); // NOI18N
        ...
        Panel_childLayout.setHorizontalGroup(
                    ...
                    .addGroup(Panel_childLayout.createSequentialGroup()
                        .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(Panel_childLayout.createSequentialGroup()
                                ...
                                .addGap(30, 30, 30)
                                .addComponent(Button_print, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(37, 37, 37)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Panel_childLayout.createSequentialGroup()
                ...
                .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lbl_sr_2, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lbl_sr_3, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(116, 116, 116)
        ...
        Panel_childLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Panel_childLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lbl_year_sem, javax.swing.GroupLayout.DEFAULT_SIZE, 47, Short.MAX_VALUE)
                ...
                .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lbl_sr_no, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE)
                        .addComponent(lbl_particulars, javax.swing.GroupLayout.DEFAULT_SIZE, 41, Short.MAX_VALUE)
                ...
                .addGroup(Panel_childLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Panel_childLayout.createSequentialGroup()
                        .addComponent(TF10, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(54, 54, 54)
        ...
        Panel2_parentLayout.setVerticalGroup(
            ...
            .addGroup(Panel2_parentLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(Panel2_parentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lbl_recipt_no)
                    .addComponent(DC1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(lbl_date)
                    .addComponent(TF1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(Panel2_parentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(Panel2_parentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGap(4, 4, 4)
                .addGroup(Panel2_parentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(Panel2_parentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setVerticalGroup(
            ...
            .addComponent(Panel2_parent, javax.swing.GroupLayout.PREFERRED_SIZE, 762, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_Fees_Details.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
